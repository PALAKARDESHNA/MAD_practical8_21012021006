package com.example.mad_practical8_21012021006
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addAlarm.setOnClickListener {
            TimePickerDialog(this, {tp, hour, minute -> setAlarmTime(hour, minute);
                card.visibility = View.VISIBLE },Calendar.getInstance().get(Calendar.HOUR),
                Calendar.getInstance().get(Calendar.MINUTE),false).show()
        }
